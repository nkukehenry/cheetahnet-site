        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-12">
                    <div class="logo flex">
                        <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>public/uploads/<?php echo $setting['logo']; ?>" style="max-width: 220px; max-height: 40px;" alt="Logo"></a>
                    </div>
                </div>
                <div class="col-lg-10 col-12 main-menu">
                    <div class="main-menu-item">
                        <ul class="nav-menu">
                            ...
                            <li class="menu-item-has-children"><a href="#"><?php echo PRODUCTS; ?></a>
                                <ul>
                            <li><a href="<?php echo base_url(); ?>services">ALL</a></li>
