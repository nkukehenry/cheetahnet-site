<!--Banner Start-->
<div class="banner-slider" style="background-image: url(<?php echo base_url(); ?>public/uploads/portfolio_photos/<?php echo $setting['banner_portfolio']; ?>)">
    <div class="bg"></div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="portfolio-carousel owl-carousel">
                    ...
                    <a href="<?php echo base_url(); ?>public/uploads/portfolio_photos/<?php echo $portfolio['photo']; ?>" class="magnific">
                        <img src="<?php echo base_url(); ?>public/uploads/portfolio_photos/<?php echo $portfolio['photo']; ?>" alt="Project Photo">
                    </a>
                ...
                <div class="portfolio-details-text">
                    <h3><?php echo "SERVICE OVERVIEW"; ?></h3>
